...
Consumption-based model: Cloud computing falls under operational expenditure (OpEx) which is spending money on services or products over time. Consumer pays only for resources used. 
